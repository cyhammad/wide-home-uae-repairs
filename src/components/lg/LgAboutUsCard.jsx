...
const LgAboutUsCard = ({ title, description }) => {
  return (
    <div className="mb-3 flex transform cursor-pointer flex-col items-center justify-between rounded shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 hover:text-white md:mt-4 md:max-w-[280px] lg:mt-10">
      ...
      <Link
        ...
        target="_blank"
        className="mb-4 flex justify-center rounded self-end mx-4 border-4 border-none bg-darkred px-14 py-2.5 text-white transition duration-300 ease-in-out hover:bg-black"
      >
        Call Us
      </Link>
    </div>

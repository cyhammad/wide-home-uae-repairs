const AboutUsCard = ({ title, description }) => {
  return (
    <div className="mb-3 max-w-sm transform cursor-pointer rounded text-center shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 hover:text-white md:mt-4 lg:mt-10">

...
const Main = () => {
  return (
    <div className="flex h-[80vh] w-full bg-[url('/main-banner.jpg')] bg-cover bg-fixed bg-center bg-no-repeat md:h-[90vh]">
        ...
        <div className="flex h-full w-full max-w-7xl flex-col justify-center gap-y-10 px-5 text-white">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              target="_blank"
              className="flex flex-shrink-0 justify-center rounded-3xl border-4 border-none bg-red px-14 py-2.5 text-white transition duration-300 ease-in-out hover:bg-white hover:text-black"
            >
              Call Us
            </Link>
            <Link
              ...
              target="_blank"
              className="flex flex-shrink-0 justify-center rounded-3xl border bg-black/50 px-14 py-2.5 text-white transition duration-300 ease-in-out hover:bg-white hover:text-black"
            >
              WhatsApp Us
            </Link>
          </div>

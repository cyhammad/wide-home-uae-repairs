        ...
        <div className="flex h-full w-full max-w-7xl flex-col justify-center gap-y-10 px-5 text-white">
          <div className="flex flex-col gap-y-5">
            <h1 className="text-4xl font-black sm:text-5xl">
              Authorized Miele Service Center: <br />
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              target="_blank"
              className="flex flex-shrink-0 justify-center rounded border-4 border-none bg-maroon px-14 py-2.5 text-white transition duration-300 ease-in-out hover:bg-white hover:text-black"
            >
              Call Us
            </Link>
            <Link

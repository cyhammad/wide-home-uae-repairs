...
const SiemensServicesCard = ({ title, description, imageSrc }) => {
  return (
    <div className="mx-5 mb-3 mt-4 flex w-screen max-w-sm transform cursor-pointer flex-col items-center justify-between overflow-hidden rounded shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 hover:text-white lg:mt-10">
      ...
      <Link
        ...
        target="_blank"
        className="mx-4 mb-5 flex flex-shrink-0 justify-center self-end rounded border-4 border-none bg-seagreen px-14 py-2.5 text-white transition duration-300 ease-in-out hover:bg-black"
      >
        Call Us
      </Link>
    </div>
...
export default SiemensServicesCard;
